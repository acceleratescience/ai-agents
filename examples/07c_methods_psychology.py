"""Develop research methods for a psychology project.
...
Output files are pulled to output_methods_psychology/ locally.
"""
...
client = air.AIR(
    ...
    local_dir=os.path.join(os.path.dirname(os.path.abspath(__file__)), "output_methods_psychology"),
)

project_name = "social-media-mental-health"
