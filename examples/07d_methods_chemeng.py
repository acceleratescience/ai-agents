"""Develop research methods for a chemical engineering project.
...
Output files are pulled to output_methods_chemeng/ locally.
"""
...
client = air.AIR(
    ...
    local_dir=os.path.join(os.path.dirname(os.path.abspath(__file__)), "output_methods_chemeng"),
)

project_name = "microreactor-polyester"
